...
struct HighQualityPlaylist: View {
    ...
    func getSheet() {
        //设置需要获取的网址
        let urlstr:String = apiServer+"/top/playlist/highquality?cookie=\(profile.user.cookie)"
...
struct HighQualityPlaylist_Previews: PreviewProvider {
